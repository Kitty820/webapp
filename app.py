...
image = Image.open("./Everything-logos.jpeg")
...
st.write("Sihouette Score for k=9:0.18932300740724375")
st.write("Davies-Bouldin Index for k=9:1.5672712280911656")
st.write("V-measure score for k=0:0,50")